...
#
#  $ bin/test -s cs.srcset -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src cs.srcset.testing.CS_SRCSET_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/cs/srcset/tests/robot/test_example.robot
#
